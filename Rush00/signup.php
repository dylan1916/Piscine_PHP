...
if (isset($_POST['login']) AND $_POST['login'] && isset($_POST['passwd']) AND $_POST['passwd'] && isset($_POST['submit']) && $_POST['submit'] === "OK" && $_POST['passwd'] === $_POST['passwd2'] && !isset($_SESSION['login']))
{
	...
	{
		$query = "INSERT INTO users (`login`, `passwd`, `lastname`, `firstname`, `email`, `address`) VALUES ('$login', '$hashed', '$lastname', '$firstname', '$email', '$address')";
